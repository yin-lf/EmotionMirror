...
const SCENES = {
  morning: {
    ...
    '平静':   { gradient: 'linear-gradient(135deg, #E8F4FD 0%, #D4E9F7 50%, #FFFFFF 100%)', animation: 'ripple' },
  ...
  afternoon: {
    ...
    '平静':   { gradient: 'linear-gradient(135deg, #D6EAF8 0%, #AED6F1 50%, #D4F1F9 100%)', animation: 'ripple' },
  ...
  evening: {
    ...
    '平静':   { gradient: 'linear-gradient(135deg, #FFECD2 0%, #FDE2C8 50%, #FCB69F 100%)', animation: 'ripple' },
  ...
  night: {
    ...
    '平静':   { gradient: 'linear-gradient(135deg, #0F2027 0%, #1B3A4B 50%, #2C5364 100%)', animation: 'ripple' },
